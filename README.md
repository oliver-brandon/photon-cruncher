...
4. Download the newest Windows zip, such as
   `Photon-Cruncher-v1.1.0-Windows.zip`.
5. Right-click the zip file and choose **Extract All...**.
6. Open the extracted `Photon Cruncher v1.1.0` folder.
7. Double-click `Photon Cruncher v1.1.0.exe`.

Keep the extracted `Photon Cruncher v1.1.0` folder together. The `.exe`
...
4. Download the newest macOS zip, such as
   `Photon-Cruncher-v1.1.0-macOS.zip`.
5. Double-click the zip file to expand it.
6. Drag `Photon Cruncher v1.1.0.app` to **Applications** or any other folder.
7. Double-click `Photon Cruncher v1.1.0.app`.
...
1. Control-click or right-click `Photon Cruncher v1.1.0.app`.
2. Choose **Open**.
...
`Photon Cruncher v1.1.0.app`, and choose **Open Anyway**. Only do this for
...
8. You should see a folder with the version in its name, such as
   `Photon Cruncher v1.1.0`.
9. Go to the place where your old `Photon Cruncher` folder lives.
10. Rename the old folder to `Photon Cruncher old`.
11. Move the new versioned `Photon Cruncher v1.1.0` folder into that same
    place.
12. Double-click `Photon Cruncher v1.1.0.exe` inside the new folder.
...
`Photon Cruncher v1.1.0.exe` by itself, because the `.exe` needs the files
beside it.
...
7. You should see a versioned app, such as `Photon Cruncher v1.1.0.app`.
8. Go to the place where your old `Photon Cruncher.app` lives, usually
   **Applications**.
9. Rename the old app to `Photon Cruncher old.app`.
10. Drag the new `Photon Cruncher v1.1.0.app` into that same place.
11. Double-click the new `Photon Cruncher v1.1.0.app`.
