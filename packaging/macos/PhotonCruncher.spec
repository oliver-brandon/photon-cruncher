...
exe = EXE(
    ...
    name="Photon Cruncher Dev v1.1.2",
    debug=False,
...
app = BUNDLE(
    coll,
    name="Photon Cruncher Dev v1.1.2.app",
    icon=str(icon_path),
    bundle_identifier="com.photoncruncher.dev",
    info_plist={
        "CFBundleDisplayName": "Photon Cruncher Dev v1.1.2",
        "CFBundleName": "Photon Cruncher Dev v1.1.2",
