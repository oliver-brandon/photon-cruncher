...
$IconPath = Join-Path $ProjectRoot "photon_cruncher\assets\icons\photon-cruncher-aurora.ico"
...
$ExpectedChannel = "aurora-dev-$Runtime"
...
Write-Host "Built Aurora dev update channel $Channel`:"
