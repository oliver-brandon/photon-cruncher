...
$AppDir = Join-Path $DistDir "Photon Cruncher Dev"
$ZipPath = Join-Path $DistDir "Photon-Cruncher-Dev-Windows.zip"
...
Write-Host "  $ZipPath"
Write-Host ""
Write-Host "You can unzip Photon-Cruncher-Dev-Windows.zip anywhere and double-click Photon Cruncher Dev.exe."
