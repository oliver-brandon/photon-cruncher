...
$AppDir = Join-Path $DistDir "Photon Cruncher v1.1.1"
$ZipPath = Join-Path $DistDir "Photon-Cruncher-v1.1.1-Windows.zip"
...
Write-Host "  $ZipPath"
Write-Host ""
Write-Host "You can unzip Photon-Cruncher-v1.1.1-Windows.zip anywhere and double-click Photon Cruncher v1.1.1.exe."
