...
$AppDir = Join-Path $DistDir "Photon Cruncher Dev v1.1.2"
$ZipPath = Join-Path $DistDir "Photon-Cruncher-Dev-v1.1.2-Windows.zip"
...
Write-Host "  $ZipPath"
Write-Host ""
Write-Host "You can unzip Photon-Cruncher-Dev-v1.1.2-Windows.zip anywhere and double-click Photon Cruncher Dev v1.1.2.exe."
