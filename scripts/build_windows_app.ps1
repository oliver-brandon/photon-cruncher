...
$AppDir = Join-Path $DistDir "Photon Cruncher"
$ZipPath = Join-Path $DistDir "Photon-Cruncher-Windows.zip"
...
Write-Host "  $ZipPath"
Write-Host ""
Write-Host "Users can unzip Photon-Cruncher-Windows.zip anywhere and double-click Photon Cruncher.exe."
